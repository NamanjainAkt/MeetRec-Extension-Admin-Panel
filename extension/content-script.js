  ...
  try {
    ...
    mediaRecorder.ondataavailable = async (event) => {
      if (event.data.size > 0) {
        ...
        // We need to convert ArrayBuffer to base64 or just send as is?
        // Chrome messaging supports serializable objects. ArrayBuffer is supported.
        // But let's send it as a standard message.
        try {
          // We need to send it as an array of numbers or base64 because direct Blob/ArrayBuffer might have issues in some contexts?
          // Actually, in MV3, we can send serializable data.
          // Let's try sending the blob data as an array of numbers (Uint8Array)
